...
# def print_sales_amount_by_categories(sales, catalog_by_item_id):
#     print("Сума на продажби по категории\n---------------------------")
#
#     sales_amount_by_category = {}  # key: city name  , value: sales amount
#     for sale_item in sales:  # sale_item : Item
#         # if sale_item.
#         item_catalog_entry = catalog_by_item_id[sale_item.item_id]
#         category_name = item_catalog_entry.category_name
#
#         if sale_item.city not in sales_amount_by_category:
#             sales_amount_by_category[sale_item.city] = Decimal(0)
#         sales_amount_by_category[sale_item.city] += sale_item.price
#
#     sales_for_display = []
#     for city, sales_amount in sales_amount_by_category.items():
#         sales_for_display.append((sales_amount, city))
#
#     sales_for_display.sort(reverse=True)
#
...
def print_highest_amount_of_sales():
    pass
